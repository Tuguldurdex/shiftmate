...
import 'features/group_chat/presentation/providers/chat_provider.dart';
...
class ShiftMateApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Load saved Ollama URL on app start
    final savedUrl = StorageService.getOllamaBaseUrl();
    if (savedUrl != null && savedUrl.isNotEmpty) {
      ref.read(ollamaBaseUrlProvider.notifier).state = savedUrl;
    }
